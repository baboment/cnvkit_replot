...
def plot_chromosome_dividers(axis, chrom_sizes, pad=None, along="x"):
    ...
    if along == "x":
        ...
        axis.set_xticklabels(list(chrom_sizes.keys()), rotation=90, fontsize=10)
        axis.tick_params(labelsize="medium")
        ...
        axis.set_yticklabels(list(chrom_sizes.keys()), fontsize=10)
        axis.tick_params(labelsize="medium")
